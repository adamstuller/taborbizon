...
var $author$project$Asset$teamImages = {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Asset$src(image),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Asset$src($author$project$Asset$camp)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
...
var $author$project$Home$viewIntro = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Tábor Bizón - 2021')
				])),
			A2(
			$elm$html$Html$h2,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Putovanie za Betlehemskou hviezdou')
				])),
			A2(
			$elm$html$Html$button,
			_List_Nil,
